...
const cloudUrlBase = `https://${lokiConfig.cloudPrefix}.saplingdata.com/${
    lokiConfig.internal ? 'sd-cloud' : 'cloud'
}`;
...
loki.environ.addConnection({
  ...
  rootUrn,
  serviceGroupUrns: [
    'urn:com:saplingdata:cloudControl:model:serviceGroups:userServices',
    'urn:com:saplingdata:cloudControl:model:serviceGroups:cloudServices',
  ],
  keyUrn,
});
...
loki.environ.addConnection({
  ...
  rootUrn,
  serviceGroupUrns: [
    'urn:com:saplingdata:cloudControl:model:serviceGroups:userServices-ui',
    'urn:com:saplingdata:cloudControl:model:serviceGroups:cloudServices-ui',
  ],
  keyUrn,
});
